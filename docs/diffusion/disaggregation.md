...
```bash
# Machine A (203.0.113.11): Encoder
sglang serve --model-path Wan-AI/Wan2.1-T2V-14B-Diffusers \
    --disagg-role encoder \
    --disagg-server-addr tcp://203.0.113.14:19655 \
    --scheduler-port 19000 \
    --num-gpus 1 \
    --disagg-p2p-hostname 203.0.113.11 --disagg-ib-device mlx5_0

# Machine B (203.0.113.12): Denoiser (4 GPUs with SP)
sglang serve --model-path Wan-AI/Wan2.1-T2V-14B-Diffusers \
    --disagg-role denoiser \
    --disagg-server-addr tcp://203.0.113.14:19655 \
    --scheduler-port 19001 \
    --num-gpus 4 --denoiser-sp 4 --denoiser-ulysses 2 --denoiser-ring 2 \
    --disagg-p2p-hostname 203.0.113.12 --disagg-ib-device mlx5_0

# Machine C (203.0.113.13): Decoder
sglang serve --model-path Wan-AI/Wan2.1-T2V-14B-Diffusers \
    --disagg-role decoder \
    --disagg-server-addr tcp://203.0.113.14:19655 \
    --scheduler-port 19002 \
    --num-gpus 1 \
    --disagg-p2p-hostname 203.0.113.13 --disagg-ib-device mlx5_0

# Machine D (203.0.113.14): DiffusionServer head
sglang serve --model-path Wan-AI/Wan2.1-T2V-14B-Diffusers \
    --disagg-role server \
    --encoder-urls  "tcp://203.0.113.11:19000" \
    --denoiser-urls "tcp://203.0.113.12:19001" \
    --decoder-urls  "tcp://203.0.113.13:19002" \
...
sglang serve --model-path ... --disagg-role server \
    --encoder-urls  "tcp://203.0.113.11:35000;tcp://203.0.113.12:35000" \
    --denoiser-urls "tcp://203.0.113.13:35000;tcp://203.0.113.14:35000" \
    --decoder-urls  "tcp://203.0.113.15:35000"
```
