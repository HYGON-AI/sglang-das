...
if amdgpu_target not in ["gfx938", "gfx942", "gfx950", "gfx1250"]:
    print(
        f"Warning: Unsupported GPU architecture detected '{amdgpu_target}'. Expected 'gfx938', 'gfx942', 'gfx950', or 'gfx1250'."
    )
    sys.exit(1)
