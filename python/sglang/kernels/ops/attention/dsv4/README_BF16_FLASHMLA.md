...
| 文件 | 作用 |
| --- | --- |
| `python/sglang/srt/environ.py` | 增加功能开关 `SGLANG_DSV4_DCU_USE_BF16_FLASH_MLA` |
...
export SGLANG_DSV4_DCU_USE_BF16_FLASH_MLA=1
```
...
- `SGLANG_DSV4_DCU_USE_BF16_FLASH_MLA=1`：启用本文档描述的 FP8 gather/upconvert
  和 BF16 FlashMLA 输入。
...
- 变量是否写成 `SGLANG_DSV4_DCU_USE_BF16_FLASH_MLA=1`。
...
```bash
export SGLANG_DSV4_DCU_USE_BF16_FLASH_MLA=0
```
