...
class MiniMaxH3SamplingParams(SamplingParams):
    ...
    # Vendor 0.5.12's SamplingParams predates the generic flow_shift field
    # used by the MiniMax-H3 request contract, so keep it on the model-specific
    # subclass for compatibility with both bases.
