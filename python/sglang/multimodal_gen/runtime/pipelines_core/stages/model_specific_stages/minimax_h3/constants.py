...
# Public MiniMax-H3 Ref2VA input contract from the release model card.  These
# are model limits, not transport/file-size policy.  Source media are probed
# and normalized independently by the material pipeline.
MINIMAX_H3_REF_MAX_IMAGE_FILES = 9
MINIMAX_H3_REF_MAX_VIDEO_FILES = 3
MINIMAX_H3_REF_MAX_AUDIO_FILES = 3
MINIMAX_H3_REF_MAX_TOTAL_FILES = 12
MINIMAX_H3_REF_MIN_CLIP_DURATION_SECONDS = 2.0
MINIMAX_H3_REF_MAX_CLIP_DURATION_SECONDS = 15.0
MINIMAX_H3_REF_MAX_TOTAL_VIDEO_DURATION_SECONDS = 15.0
MINIMAX_H3_REF_MAX_TOTAL_AUDIO_DURATION_SECONDS = 15.0
