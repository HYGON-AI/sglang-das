...
def build_draft_tp_worker(
    *,
    ...
    # The draft's model construction runs its own MoE gates; the scopes route
    # construction-time decisions to the speculative leaf without changing the
    # target model's backend state.
