...
class DeepseekV4Model(nn.Module):
    ...
    def forward(
        ...
        for i in range(self.start_layer, self.end_layer):
            # Keep the current layer available to the expert distribution recorder.
            # Context managers are skipped for piecewise CUDA graphs because Dynamo
            # cannot trace through them. Enabling the recorder disables that mode.
            ctx = (
                nullcontext()
