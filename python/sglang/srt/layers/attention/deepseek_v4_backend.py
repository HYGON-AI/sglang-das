...
_DSV4_USE_BF16_SPARSE_ATTN = envs.SGLANG_DSV4_USE_BF16_SPARSE_ATTN.get()
    ...
    def _forward_prefill_sparse(
        ...
        *,
        ...
        if compress_ratio == 0:
            ...
            extra_page_size = token_to_kv_pool.page_size // compress_ratio
            ...
            if compress_ratio == 128:
                ...
                combined_indices, combined_lens = cache.combine_c4_layer(
                    core_attn_metadata.c4_sparse_raw_indices
                )
    ...
    def forward(
        ...
        **_,
        ...
        if isinstance(core_attn_metadata, DSV4AttnMetadata):
            ...
            if _DSV4_USE_BF16_SPARSE_ATTN and token_to_kv_pool.dtype != torch.bfloat16:
                raise RuntimeError(
                    "SGLANG_DSV4_USE_BF16_SPARSE_ATTN=1 requires "
            ...
            if use_bf16_sparse_attn and extra_k_cache is not None:
                page_sizes = {
