...
class Fp8MoEMethod(FusedMoEMethodBase):
    ...
    def process_weights_after_loading_block_quant(self, layer: Module) -> None:
        ...
        # HCU has no aiter MXFP4 MoE kernel and keeps the generic path.
        if (
            _use_aiter
            and self.is_fp4_expert
            and not _is_hcu
            and not self.dequant_fp4_to_fp8
        ):
        ...
        if _is_hcu and (_use_aiter or SGLANG_USE_AITER_FP8_ASM_MOE):
            # HCU aiter ASM MoE kernels consume the b8 weight layout.
            ...
            del w2_weight
        elif _is_fp8_fnuz and not _is_hcu:
            # Upstream ROCm: the fnuz arm above already normalized and shuffled.
            pass
        elif _use_aiter:
            # Pre-shuffle weights
