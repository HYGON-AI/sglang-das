...
class DecodeKVCacheOffloadManager:
    ...
    def __init__(
        ...
        # build_kv_host_pool() already routes MHA pools through
        # get_mha_host_pool_cls(kv_pool, hicache_mem_layout), so the HCU
        # layout_hcu host pool is still selected here.
