...
class DataParallelController:
    ...
    def __init__(
        ...
        if get_parallel().enable_dp_attention:
            ...
            # HCU keeps the env override ahead of the config bag so the knob can
            # be flipped without a CLI change.
            local_ctrl = (
                envs.SGLANG_ENABLE_DP_ATTENTION_LOCAL_CONTROL_BROADCAST.get()
                or get_parallel().enable_dp_attention_local_control_broadcast
            )
