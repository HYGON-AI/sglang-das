...
def get_last_loc(
    ...
    if (_is_hip or _is_npu) and not _is_hcu and uses_triton_dispatch:
        # HIP and NPU DSV4 (but not HCU): the legacy get_last_loc_triton kernel emits a
    ...
    if _is_hcu and get_bool_env_var("SGLANG_GET_LAST_LOC", default="true"):
