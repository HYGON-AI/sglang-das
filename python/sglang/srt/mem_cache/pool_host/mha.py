...
def get_mha_host_pool_cls(
    ...
    (e.g. MiMo-V2), else the default ``MHATokenToKVPoolHost``. HCU's page-major
    FlashAttention layout owns a dedicated host pool; other layouts and generic
    HIP retain the official host-pool implementations.
    """
