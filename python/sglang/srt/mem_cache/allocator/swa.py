...
class SWATokenToKVPoolAllocator(BaseTokenToKVPoolAllocator):
    ...
    def free_swa(self, free_index: torch.Tensor):
        ...
        # get_all_free_pages() already spans the staged frees upstream added in
        # place of `release_pages`, so this needs no merge of its own.
        already_free = torch.isin(
            unique_swa // page_size, self.swa_attn_allocator.get_all_free_pages()
        )
