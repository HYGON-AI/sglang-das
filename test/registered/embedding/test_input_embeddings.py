...
register_cuda_ci(est_time=38, stage="stage-b", runner_config="1-gpu-small")
register_amd_ci(est_time=38, suite="stage-b-test-1-gpu-small-amd")


# HCU BW1100 validated on 10.16.1.66/dxl-sglang: input_embeddings path passed three runs.
register_hcu_ci(
    est_time=120,
