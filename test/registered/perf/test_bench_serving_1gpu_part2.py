...
register_dcu_ci(est_time=900, suite="nightly-dcu-perf", nightly=True, disabled='DCU Full Enabled run 26941698027 failed; keep disabled until BW1000 failure is fixed or revalidated.')
