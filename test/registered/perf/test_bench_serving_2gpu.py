...
register_dcu_ci(
    ...
    nightly=True,
    disabled="DCU BW1100 2GPU perf candidate maps to AMD large-GPU MoE/PP/70B throughput tests; keep disabled until local Mixtral/Llama-70B assets and DCU throughput thresholds are defined.",
)
