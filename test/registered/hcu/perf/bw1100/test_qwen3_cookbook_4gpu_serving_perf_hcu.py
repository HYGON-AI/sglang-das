        ...
        for config in configs:
            with self.subTest(model=config.name):
                ...
                assert_cookbook_min_output_throughput(
                    ...
                    result,
                    COOKBOOK_QWEN3_4GPU_MIN_OUTPUT_TPS,
                    "SGLANG_HCU_QWEN3_4GPU_MIN_OUTPUT_TPS",
                )
