...
class TestGlm51Cookbook8GpuServingPerfHCU(unittest.TestCase):
    def test_glm51_random_serving_perf(self):
        ...
        configs = selected_configs(
            GLM51_8GPU_PERF_MODELS, "SGLANG_HCU_GLM51_8GPU_PERF_MODEL_FILTER"
        )
        ...
        for config in configs:
            with self.subTest(model=config.name):
                ...
                assert_cookbook_min_output_throughput(
                    ...
                    result,
                    COOKBOOK_GLM51_8GPU_MIN_OUTPUT_TPS,
                    "SGLANG_HCU_GLM51_8GPU_MIN_OUTPUT_TPS",
                )
