    ...
    def setUpClass(cls):
        ...
        cls.process = popen_launch_server(
            ...
            other_args=get_server_args(
                "SGLANG_HCU_FUNCTION_CALLING_SERVER_ARGS",
...
@unittest.skip("HCU smoke keeps the Llama3 parser path; pythonic parser starts a separate server and currently exits -9 on BW1100")
