...
class TestMiniMaxM25Cookbook8GpuServerHCU(unittest.TestCase):
    def test_minimax_m25_cookbook_8gpu_chat(self):
        configs = selected_configs(
            MINIMAX_M25_8GPU_MODELS, "SGLANG_HCU_MINIMAX_M25_8GPU_MODEL_FILTER"
        )
