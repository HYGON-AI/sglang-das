...
class TestQwen3W8A8CookbookOptHCU(unittest.TestCase):
    def test_qwen3_w8a8_cookbook_chat(self):
        configs = selected_configs(
            QWEN3_4GPU_QUANT_MODELS, "SGLANG_HCU_QWEN3_QUANT_MODEL_FILTER"
        )
