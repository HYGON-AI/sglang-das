...
# HCU-specific copy of test/registered/models/test_reward_models.py.
# Changes:
...
class TestRewardModelsHCU(CustomTestCase):
    @classmethod
    def setUpClass(cls):
        cls.model = get_model_path("SGLANG_HCU_REWARD_MODEL", DEFAULT_HCU_REWARD_MODEL)
