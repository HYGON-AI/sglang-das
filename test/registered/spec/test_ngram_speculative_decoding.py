...
register_cuda_ci(est_time=230, stage="stage-b", runner_config="1-gpu-large")
...
register_hcu_ci(
    ...
    nightly=False,
    disabled="HCU CSV CI placeholder: ngram speculative decoding path needs BW1100 validation before enabling.",
)
