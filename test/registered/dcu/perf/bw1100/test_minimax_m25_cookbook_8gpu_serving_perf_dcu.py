...
COOKBOOK_MINIMAX_M25_8GPU_MIN_OUTPUT_TPS = {
    "MiniMax-M2.5": 280.0,
}


class TestMiniMaxM25Cookbook8GpuServingPerfDCU(unittest.TestCase):
    def test_minimax_m25_random_serving_perf(self):
        ...
        configs = selected_configs(
            MINIMAX_M25_8GPU_PERF_MODELS,
            "SGLANG_DCU_MINIMAX_M25_8GPU_PERF_MODEL_FILTER",
        )
        ...
        for config in configs:
            with self.subTest(model=config.name):
                ...
                assert_cookbook_min_output_throughput(
                    ...
                    result,
                    COOKBOOK_MINIMAX_M25_8GPU_MIN_OUTPUT_TPS,
                    "SGLANG_DCU_MINIMAX_M25_8GPU_MIN_OUTPUT_TPS",
                )
