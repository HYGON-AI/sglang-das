...
from sglang.test.dcu_cookbook_utils import (
    CookbookServer,
    DEEPSEEK_V32_8GPU_QUANT_MODELS,
    selected_configs,
)
...
class TestDeepSeekV32CookbookQuantOptDCU(unittest.TestCase):
    def test_deepseek_v32_quant_chat(self):
        configs = selected_configs(
            DEEPSEEK_V32_8GPU_QUANT_MODELS,
            "SGLANG_DCU_DEEPSEEK_V32_QUANT_MODEL_FILTER",
        )
