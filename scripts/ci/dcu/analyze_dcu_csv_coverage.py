...
def write_markdown(csv_matrix: list[CoverageRow], intersection_rows: list[dict]):
    ...
    intersection_doc = [
        "# DCU ROCm/NVIDIA Intersection Coverage Matrix",
        "",
        "Generated by `python3 scripts/ci/dcu/analyze_dcu_csv_coverage.py --write-md`.",
        "",
        ...
        _markdown_table(
            ["Metric", "Value"],
            [
                ["DCU/ROCm and NVIDIA intersection", len(intersection_rows)],
...
def main() -> int:
    ...
    print("DCU/ROCm and NVIDIA Intersection Matrix")
    ...
    if args.write_md:
        ...
        print("Wrote DCU/ROCm and NVIDIA intersection coverage matrix markdown")
