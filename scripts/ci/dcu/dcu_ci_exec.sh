...
ENV_MAP[SGLANG_DCU_QWEN25_0P5B_MODEL]="${SGLANG_DCU_QWEN25_0P5B_MODEL:-/public/opendas/DL_DATA/llm-models/qwen2.5/Qwen2.5-0.5B-Instruct}"
...
ENV_MAP[SGLANG_DCU_MMLU_DATASET_PATH]="${SGLANG_DCU_MMLU_DATASET_PATH:-/public/opendas/DL_DATA/llm-models/datasets/mmlu}"
ENV_MAP[SGLANG_DCU_MMMU_DATASET_PATH]="${SGLANG_DCU_MMMU_DATASET_PATH:-/public/opendas/DL_DATA/llm-models/multimodal-datasets/MMMU}"
ENV_MAP[SGLANG_TEST_DCU_DEFAULT_SERVER_ARGS]="${SGLANG_TEST_DCU_DEFAULT_SERVER_ARGS:---attention-backend fa3 --page-size 64 --trust-remote-code}"
